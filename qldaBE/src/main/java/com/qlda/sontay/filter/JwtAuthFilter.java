package com.qlda.sontay.filter;

import com.qlda.sontay.service.auth.JwtService;
import com.qlda.sontay.utils.CacheUtil;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (request.getServletPath().equals("/api/authenticate") || request.getServletPath().startsWith("/api/v1/auth/")) {
