...
export interface ProjectPhaseCategory extends ProjectPhase {}
...
export interface ProjectPayload {
  ...
  // `relatedDocuments` khi upload sẽ là `File[]`, khi hiển thị sẽ là `RelatedDocument[]`
  relatedDocuments?: (RelatedDocument | File)[];

  roleExecutor?: string;
  capitalProject?: string;
  field?: string;
